...
/**
 * Логирует навигацию роутера.
 */
fun <C : Any, T : Any> Router<C, T>.log(routerName: String): Router<C, T> {
    state.subscribe { routerState ->
        val childName = routerState.activeChild.instance::class.qualifiedName
